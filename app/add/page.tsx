    ...
    return(
        <section dir={'rtl'} className={'flex items-center flex-col justify-center w-full mt-24 gap-10'}>
            ...
            <form dir={'rtl'} action="" className={'flex flex-col justify-center items-center'}>
                ...
                <input type="text" className={'border-2 border-black'} onChange={(e) => setFormData({...formData, name:e.target.value})}/>
                ...
                <input type="time" className={'border-2 border-black'} onChange={(e) => setFormData({...formData, time:e.target.value})}/>

                <label htmlFor="">סכום</label>
                <input type="number" min={0} className={'border-2 border-black'} onChange={(e) => setFormData({...formData, cash:Number(e.target.value)})}/>
